...
const Banner = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      <section className="bg-[#0F1117] text-white min-h-[calc(100vh-64px)] flex flex-col justify-center py-4 px-3 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto w-full bg-[#171923] rounded-2xl overflow-hidden border  border-[#262936]  shadow-2xl">
          ...
          <div className="relative">
            ...
            <div className="sm:hidden absolute left-1/2 -translate-x-1/2 -bottom-14 z-30 w-28 h-28 rounded-full   overflow-hidden  shadow-2xl ring-1 ring-[#C9A876]/30">
              <img
          ...
          <div className="relative px-4 sm:px-6 lg:px-8 bg-[#171923]">
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 pt-16 sm:pt-0 sm:-mt-16 lg:-mt-[72px] pb-4">
              ...
              <div className="flex flex-col items-center sm:flex-row sm:items-end gap-0 sm:gap-4 text-center sm:text-left z-20">
                <div className="hidden sm:block sm:w-36 sm:h-36 lg:w-[152px] lg:h-[152px] rounded-full  overflow-hidden bg-[#0F1117] shadow-2xl shrink-0 ring-1 ring-[#C9A876]/30">
                  <img
                ...
                <div className="mt-2 sm:mt-0 sm:mb-2">
                  ...
                  <h2 className="font-['Inter'] text-base font-medium text-white/70 mt-0.5">
                    I&apos;m a{" "}
                    <span
                      ref={typedElement}
              ...
              <div className="flex flex-col items-center sm:items-end gap-2.5 z-20 w-full sm:w-auto">
                ...
                <div className="flex gap-2 sm:gap-3 bg-[#171923] px-3 sm:px-4 py-1.5 sm:py-2 rounded-xl border border-[#C9A876]/30 flex-shrink-0">
                  <div className="text-center">
                    <p className="text-base font-bold text-[#C9A876] font-['Inter']">2+</p>
                  ...
                  <div className="text-center">
                    <p className=" sm:text-base font-bold text-[#C9A876] font-['Inter']">10+</p>
                  ...
                  <div className="flex gap-1 sm:gap-1.5">
                    {socialLinks.map((social, index) => (
                      <a
                        ...
                        className="w-7 h-7 sm:w-8 sm:h-8 md:w-9 md:h-9 rounded-full flex justify-center items-center border border-[#C9A876]/30 bg-[#171923] hover:bg-[#0F1117] text-whit hover:text-[#F5EFE6] transition-all duration-300 hover:scale-110 shadow-sm"
                        title={social.label}
                      >
            ...
            <p className="hidden sm:block text-right mt-2 max-w-7xl text-start  text-white/60 font-['Inter'] leading-relaxed">
